...
Genre: <span class="pull-right">Drama, Comedy</span></h6>
         <hr class="hr_1">
		 <h6 class="fw-normal">
Director: <span class="pull-right">Subash Kapoor</span></h6>
         <hr class="hr_1">
		  <h6 class="fw-normal">
Stars: <span class="pull-right">
Akshay Kumar,Arshad Warsis</span></h6>
         <hr class="hr_1">
		 <h6 class="fw-normal">
Release Date: <span class="pull-right">Aug 2025</span></h6>
         <hr class="hr_1 mb-0">
		</div>
	   </div>
...
IMDB Rating: <span class="pull-right">--</span></h6>
         <hr class="hr_1">
		  <h6 class="fw-normal">
Writers: <span class="pull-right">Subhash Kapoor</span></h6>
         <hr class="hr_1">
...
<div class="play_m clearfix">
 ...
 <div class="row trend_1">
  <div class="col-md-12">
   <div class="trend_1l">
    <h4 class="mb-0"> Movie  <span class="col_red">Trailer   <a href >https://https://youtu.be/buL8H-udimM?si=xObAjZIs5_FV-9bp</span></h4>
   </div>
  </div>
 </div>
