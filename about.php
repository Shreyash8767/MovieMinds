  ...
  <div class="col-md-4">
   <div class="top_1r text-end">
     <ul class="social-network social-circle mb-0">
			...
			<li><a href="https://www.linkedin.com/in/swastik-kashyap-92a77b284?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
		</ul>
   </div>
  </div>
 </div>
...
<section id="about_pg">
 <div class="about_pgm">
  ...
  <div class="row about_pg1">
    <div class="col-md-12">
	  <h2><span class="col_red">Welcome To MovieHub</span><br></h2>
...
&nbsp
    ...
    <div class="col-md-3 col-6">
		  ...
		  <figure class="effect-jazz mb-0">
			<a><img src="images/img117.png" class="w-100" alt="img25"></a>
		  </figure>
	  </div>
		   </div>
		  ...
		  <div class="trend_2ilast bg_grey p-3 clearfix">
		    <h5><a class="col_red" >Swastik Kashyap</a></h5>
			<p class="mb-2">Owner of MovieHub <br> Student Pursuing BBA-CA </p>
     ...
     <ul class="social-network social-circle mb-0">
			...
			<li><a href="https://www.instagram.com/swastik.kashyap23/" class="icoRss" title="Rss"><i class="fa fa-instagram"></i></a></li>
			<li><a href="https://www.linkedin.com/in/swastik-kashyap-92a77b284?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="icoLinkedin" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
		</ul>
   </div>
	...
	<div class="col-md-3 col-6">
		  <div class="trend_2im clearfix position-relative">
		   <div class="trend_2im1 clearfix">
		     <div class="grid">
		  <figure class="effect-jazz mb-0">
			<a><img src="images/img1377.jpg" class="w-100" alt="img25"></a>
		  </figure>
	  </div>
		   </div>
		  ...
		  <div class="trend_2ilast bg_grey p-3 clearfix">
		    <h5><a class="col_red">Viraj Patil</a></h5>
			<p class="mb-2">Owner of MovieHub <br> Student Pursuing BBA-CA</p>
     ...
     <ul class="social-network social-circle mb-0">
			<a class="col_red" >Follow me - </a>
			<li><a href="https://www.instagram.com/____viruuuu____/?hl=en" class="icoRss" title="Rss"><i class="fa fa-instagram"></i></a></li>
