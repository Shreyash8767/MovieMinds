...
<div class="play_m clearfix">
 ...
 <div class="row trend_1">
  <div class="col-md-12">
   <div class="trend_1l">
    <h2 class="mb-0"><span class="col_red">Chaava</span></h2>
   </div>
  </div>
 </div>
 ...
 <div class="play2 row mt-4">
  ...
  <div class="col-md-8 p-0">
   <div class="play2r  bg_black p-4">
	  ...
	  <hr class="line">
	  <p class="mt-3">Chhaava is a 2025 Indian Hindi-language historical action film based on the life of Sambhaji Maharaj, the second ruler of the Maratha Empire, who is played by Vicky Kaushal.</p>
					   			 Feb 14, 2025
	  </p>
	  <div class="play2ri row mt-4">
	   <div class="col-md-6">
	    <div class="play2ril">
		 <h6 class="fw-normal">
Running Time: <span class="pull-right">2 hr 35 min</span></h6>
         <hr class="hr_1">
		  <h6 class="fw-normal">
Genre: <span class="pull-right">Action,Drama</span></h6>
		 ...
		 <h6 class="fw-normal">
Director: <span class="pull-right">Laxman Utekar</span></h6>
         <hr class="hr_1">
		  <h6 class="fw-normal">
...
Vicky Kaushal
         ...
         <hr class="hr_1">
		 <h6 class="fw-normal">
Release Date: <span class="pull-right">Feb 14, 2025
</span></h6>
         <hr class="hr_1 mb-0">
		</div>
	   </div>
...
IMDB Rating: <span class="pull-right">8.0/10</span></h6>
         <hr class="hr_1">
		  <h6 class="fw-normal">
Writers: <span class="pull-right">A.R Rahman</span></h6>
         <hr class="hr_1">
...
<div class="play_m clearfix">
 ...
 <div class="row trend_1">
  <div class="col-md-12">
   <div class="trend_1l">
    <h4 class="mb-0"> Movie  <span class="col_red">Trailer</span> <a href >https://youtu.be/77vRyWNqZjM?si=02qulGj_yzLOHVTU</h4>
...
<div class="reviews">
    <div class="review-item">
        <h4>Pratik</h4>
        <p>⭐⭐⭐⭐☆</p>
        <p>Chaava is an absolute cinematic masterpiece that brings the legend of Maharaja Chhatrapati Sambhaji Maharaj to life with breathtaking visuals and emotionally charged storytelling. Every scene is a visual wonder, immersing the audience in the grandeur of history while delivering powerful moments that send chills down the spine.</p>
    </div>

    <div class="review-item">
        <h4>Shreyash T</h4>
        <p>⭐⭐⭐⭐⭐</p>
        <p>From start to finish, Chaava keeps the audience captivated with its larger-than-life storytelling, mesmerizing visuals, and powerful performances. Whether it’s the war scenes, the inspiring speeches, or the heartfelt moments of love and sacrifice, this film is an unforgettable tribute to the legendary warrior king. A must-watch for history enthusiasts and cinema lovers alike!.</p>
    </div>
	<div class="review-item">
        <h4>Abhi</h4>
        <p>⭐⭐⭐☆☆</p>
        <p>Bollywood has delivered many great historical films, but Chhaava stands out as one of the finest cinematic achievements of the 21st century. From its stellar performances to its breathtaking cinematography, powerfu</p>
    </div>
	<div class="review-item">
        <h4>omkar</h4>
        <p>⭐⭐⭐⭐☆</p>
	...
	<div class="review-item">
        <h4>Deepak</h4>
        <p>⭐⭐⭐⭐⭐</p>
        <p>A Grand Tribute to a Fearless Warrior</p>
    </div>
